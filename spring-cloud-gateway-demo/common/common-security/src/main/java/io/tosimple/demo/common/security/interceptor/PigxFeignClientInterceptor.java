package io.tosimple.demo.common.security.interceptor;
...
public class PigxFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public PigxFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext, OAuth2ProtectedResourceDetails resource,
